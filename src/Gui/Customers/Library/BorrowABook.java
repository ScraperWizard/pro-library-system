    ...
    public BorrowABook() {
        ...
        borrowButton.addActionListener(clickEvent -> {
            ...
            if(selectedBooks.isEmpty()) {
                JOptionPane.showMessageDialog(panel, "Dear customer, please select a book to borrow");
            } else {
                try {
                    ...
                    JOptionPane.showMessageDialog(panel, "An error has occured while borrowing the book!");
...
//	        jFrame.add(scrollPane_1);
    ...
    public void addBookToList(BooksDB book) {
