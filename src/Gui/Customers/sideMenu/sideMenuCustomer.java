...
import Gui.Customers.Books.CustomersList;
import Gui.Customers.Library.BorrowBooks;
import Gui.Staff.Books.Books;
import Gui.Staff.Customers.Customer;
import Gui.Staff.sideMenu.sideMenu;

public class sideMenuCustomer extends JFrame {
     ...
     * Create the frame.
     */
    public sideMenuCustomer(JFrame mainFrame) {
        ...
        mainFrame.setTitle("Pro Library - customer");
        ...
        lblHome.setFont(new Font("Dialog", Font.PLAIN, 18));
        ...
        JLabel lblCustomers = new JLabel("MY BOOKS");
        lblCustomers.setForeground(new Color(254, 255, 255));
        lblCustomers.setFont(new Font("Dialog", Font.PLAIN, 18));
        ...
        Library.setBorder(new LineBorder(new Color(0, 0, 0)));
        Library.setBackground(new Color(83, 107, 123));
        Library.setBounds(0, 310, 270, 50);
        sideMenuPanel.add(Library);
        Library.setLayout(null);

        JLabel lblBooks = new JLabel("LIBRARY");
        lblBooks.setForeground(new Color(254, 255, 255));
        lblBooks.setFont(new Font("Dialog", Font.PLAIN, 18));
        lblBooks.setBounds(90, 6, 104, 34);
        Library.add(lblBooks);
        ...
        JLabel lblNull = new JLabel("CUSTOMER SERVICE");
        lblNull.setForeground(new Color(254, 255, 255));
        lblNull.setFont(new Font("Dialog", Font.PLAIN, 16));
        lblNull.setBounds(88, 6, 200, 34);
        ...
        lblSettings.setFont(new Font("Dialog", Font.PLAIN, 18));
        ...
        lblSignOut.setFont(new Font("Dialog", Font.PLAIN, 18));
...
//        lblNewLabel_2.setFont(new Font("Dialog", Font.BOLD, 14));
        ...
        MouseAdapter panelMouseEventHandler = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent event) {
                ...
                if(optionClicked == Library) {
                    BorrowBooks books = new BorrowBooks(mainFrame);
                    contentPane.add(books.booksPane);
                }

                else if(optionClicked == customersPanel) {
                    CustomersList listOfBooks = new CustomersList(mainFrame);
                    mainFrame.setContentPane(listOfBooks.getContentPane());
                }
        ...
        Library.addMouseListener(panelMouseEventHandler);
